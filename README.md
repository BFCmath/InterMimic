...
- 🔥 We recommend processing the data using our [InterAct](https://github.com/wzyabcas/InterAct) to obtain richer HOI skills and higher-quality outputs than the original OMOMO dataset.
